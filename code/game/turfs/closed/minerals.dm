...
/turf/closed/mineral/random/megastructure/
	...
	baseturfs = /turf/open/floor/iron/dark/smooth_large/megastructure

/turf/closed/mineral/random/empty/megastructure/danger
	baseturfs = /turf/open/chasm/megastructure

/turf/closed/mineral/random/megastructure/mineral
...
/turf/closed/mineral/random/megastructure/mineral/mineral_chances()
	return list(
		...
		/obj/item/stack/ore/uranium = 5,
		/turf/closed/mineral/random/empty/megastructure = 50,
		/turf/closed/mineral/random/empty.megastructure/danger = 5,
	)
